...
// check the hero's upgration effect status
// it's only happen once upon up level, will not do when level down
var saiyan1 = false;
var saiyan2 = false;
var icon = 0;
var bossicon = 0;
//player's start status
...
var Enemy = function(positionY, speed) {
	...
	var enemyArray = ['shalu.png','finalboss.png'];
    this.sprite = 'images/' +  enemyArray[bossicon];
...
/* Reset Enemies
 * Clear all enemies from the canvass
 */
Enemies.prototype.reset = function() {

		var enemyArray = ['shalu.png','finalboss.png'];
		this.sprite = 'images/' +  enemyArray[1];
...
var Gem = function(positionX, positionY) {
		...
		var gemArray = ['ball.png', 'ball2.png'];
		// Set a random gem image from the gemArray
		this.sprite = 'images/' + gemArray[getRandomInt(0,1)];
...
Gems.prototype.spawn = function(number) {
		...
		for(var i = 0; i < number; i++) {
			...
			var positionY = getRandomInt(0, 0);
...
var Player = function() {
		// Set the player's image,icon = 0, 1, 2

		var playerArray = ['goku.png','goku2.png','goku3.png'];
	//set the player to its current status icon
		this.sprite = 'images/' + playerArray[icon];
...
Stats.prototype.gems = function() {
		ctx.drawImage(Resources.get('images/stat-ball.png'), 340, 62);
		ctx.font = this.font;
		ctx.fontStyle = this.fontColor;
		ctx.textAlign = 'start';
